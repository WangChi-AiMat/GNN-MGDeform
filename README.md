...
The graph data is already prepared and located in the `MGDataset` directory. As the file size exceeds the GitHub limit, it has been uploaded to the Figshare shared repository with the link: https://doi.org/10.6084/m9.figshare.31832974. You only need to simply place this file in the directory like this: "./MGDataset".
